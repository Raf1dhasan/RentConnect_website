...
<head>
    ...
    <title>Property Details - Basement for Rent on Summit Drive</title>
    <!-- Bootstrap CSS -->
...
<header class="property-header">
    <h1>Basement for Rent on Summit Drive</h1>
</header>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="property-images">
                    <img src="prop8_img1.webp" alt="Living Room">
                    <img src="prop8_img2.webp" alt="Bedroom">
                    <img src="prop8_img3.webp" alt="Kitchen">
                    <img src="prop8_img4.webp" alt="Bathroom">
                </div>
            </div>
            <!-- Property Details -->
            <div class="col-md-4">
                <h2>Property Details</h2>
                <p><strong>Price:</strong> <span class="price">$1,200/month</span></p>
                <p><strong>Details:</strong> A cozy and modern basement suite available for rent in a townhouse located on Summit Drive. Perfect for students or professionals, this suite offers easy access to public transportation and a quiet, family-friendly environment. Enjoy a spacious living area, a well-equipped kitchen, and proximity to amenities.</p>
                <p><strong>Location:</strong> Summit Drive, Kamloops, BC</p>
        ...
        <div class="row mt-5">
            <div class="col-12">
                ...
                <div class="map-container">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3280.2744727527877!2d-120.3468859!3d50.6600914!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x537e2d9e65cdeef5%3A0x99ae4f2995a4a4b2!2sSummit%20Dr%2C%20Kamloops%2C%20BC!5e0!3m2!1sen!2sca!4v1700519001234!5m2!1sen!2sca"
                        allowfullscreen=""
                        loading="lazy"></iframe>
                </div>
            </div>
