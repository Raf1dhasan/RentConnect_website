...
<head>
    ...
    <title>Modern Studio Apartment near TRU</title>
    <!-- Bootstrap CSS -->
...
<header class="property-header">
    <h1>Modern Studio Apartment near TRU</h1>
</header>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="property-images">
                    <img src="prop6_img1.webp" alt="Living Room">
                    <img src="prop6_img2.webp" alt="Building Exterior">
                </div>
            </div>
            <!-- Property Details -->
            <div class="col-md-4">
                <h2>Property Details</h2>
                <p><strong>Price:</strong> <span class="price">$950/month</span></p>
                <p><strong>Details:</strong> This modern studio apartment is located near Thompson Rivers University (TRU) in Kamloops, BC. Designed for students and young professionals, the property offers a cozy and well-lit space with stunning views and proximity to local amenities. It is a perfect choice for those looking for convenience and comfort near the university.</p>
                <p><strong>Location:</strong> Near TRU, Kamloops, BC</p>
                <p><strong>Features:</strong></p>
                <ul>
                    <li>Proximity to Thompson Rivers University (TRU)</li>
                    <li>Modern kitchen with appliances</li>
                    <li>High-speed internet available</li>
                    <li>Secure building access</li>
                    <li>Beautiful city and nature views</li>
                </ul>
        ...
        <div class="row mt-5">
            <div class="col-12">
                ...
                <div class="map-container">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2627.186926623529!2d-120.3604949!3d50.67202!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x537e2d0063bb5c1f%3A0x4c8fdaca069f6505!2sCoyote%20Den%20%7C%20Sk%CC%93elep%C3%A9llcw!5e0!3m2!1sen!2sca!4v1700516007987"
                        allowfullscreen=""
                        loading="lazy"
