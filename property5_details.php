...
<head>
    ...
    <title>Property Details - Modern 2-Bedroom Condo</title>
    <!-- Bootstrap CSS -->
...
<header class="property-header">
    <h1>Bright & Modern 2-Bedroom Condo</h1>
</header>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="property-images">
                    <img src="prop5_img1.webp" alt="Interior View">
                    <img src="prop5_img2.webp" alt="Building Exterior">
                </div>
            </div>
            <!-- Property Details -->
            <div class="col-md-4">
                <h2>Property Details</h2>
                <p><strong>Price:</strong> <span class="price">$1,900/month</span></p>
                <p><strong>Details:</strong> Experience upscale city living in this bright and modern 2-bedroom condo. The open-concept design is complemented by floor-to-ceiling windows, sleek finishes, and access to luxurious amenities like a private gym and rooftop garden. Conveniently located close to shopping centers, parks, and public transit.</p>
        ...
        <div class="row mt-5">
            <div class="col-12">
                ...
                <div class="map-container">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3133.1746926754243!2d-120.34281448417712!3d50.677917979506376!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x537e2d24ef25e839%3A0xa09e7cf5f7df27b8!2sVictoria%20St%2C%20Kamloops%2C%20BC!5e0!3m2!1sen!2sca!4v1637284854911!5m2!1sen!2sca"
                        allowfullscreen=""
                        loading="lazy"></iframe>
                </div>
            </div>
