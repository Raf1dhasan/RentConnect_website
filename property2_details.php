...
<head>
    ...
    <title>Property Details - Sahali Apartment</title>
    <!-- Bootstrap CSS -->
...
<header class="property-header">
    <h1>Spacious Sahali Apartment Near Elementary School</h1>
</header>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="property-images">
                    <img src="prop2_img1.webp" alt="Living Room">
                    <img src="prop2_img2.webp" alt="Bedroom">
                    <img src="prop2_img3.webp" alt="Kitchen">
                    <img src="prop2_img4.webp" alt="Neighborhood">
                </div>
            </div>
            <!-- Property Details -->
            <div class="col-md-4">
                ...
                <p><strong>Details:</strong> This spacious Sahali apartment is located in a serene and family-friendly neighborhood, just steps away from a well-rated elementary school. Ideal for small families or professionals, this property features a modern design, a fully equipped kitchen, and large windows offering plenty of natural light. The peaceful location makes it perfect for those looking for a quiet retreat while being close to city amenities.</p>
                <p><strong>Location:</strong> Sahali, Kamloops, BC</p>
                <p><strong>Bedrooms:</strong> 3</p>
                <p><strong>Bathrooms:</strong> 2</p>
                <p><strong>Features:</strong></p>
                <ul>
                    <li>Quiet neighborhood near elementary school</li>
                    <li>Modern kitchen with updated appliances</li>
                    <li>Private parking space</li>
                    <li>Close to shopping centers</li>
                    <li>Pet-friendly</li>
                    <li>Large balcony with scenic views</li>
                </ul>
        ...
        <div class="row mt-5">
            <div class="col-12">
                ...
                <div class="map-container">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2630.893987204192!2d-120.34084348263773!3d50.659784981011154!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x537e2e3c0f31c491%3A0xa56b13835421257d!2sSahali%2C%20Kamloops%2C%20BC!5e0!3m2!1sen!2sca!4v1698518008043!5m2!1sen!2sca"
                        allowfullscreen=""
                        loading="lazy"></iframe>
                </div>
            </div>
