...
<head>
    ...
    <title>Property Details - Scenic Retreat in Aberdeen</title>
    <!-- Bootstrap CSS -->
...
<header class="property-header">
    <h1>Scenic Retreat in Aberdeen</h1>
</header>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="property-images">
                    <img src="prop9_img1.webp" alt="Living Room">
                    <img src="prop9_img2.webp" alt="Bedroom">
                    <img src="prop9_img3.webp" alt="Bathroom">
                    <img src="prop9_img4.webp" alt="Kitchen">
                </div>
            </div>
            <!-- Property Details -->
            <div class="col-md-4">
                <h2>Property Details</h2>
                <p><strong>Price:</strong> <span class="price">$2,600/month</span></p>
                <p><strong>Details:</strong> Discover this serene retreat in the prestigious Aberdeen area. This charming property offers modern interiors, spacious rooms, and breathtaking views of nature. With proximity to parks, Aberdeen Mall, and peaceful neighborhoods, it's perfect for families or professionals seeking a tranquil lifestyle. Enjoy top-tier amenities, including a modern kitchen, cozy living spaces, and a luxurious bathroom.</p>
                <p><strong>Location:</strong> Aberdeen, Kamloops, BC</p>
                <p><strong>Features:</strong></p>
                <ul>
                    <li>Scenic views of nature</li>
                    <li>Modern and fully equipped kitchen</li>
                    <li>Luxurious bathroom with high-end finishes</li>
                    <li>Close to Aberdeen Mall</li>
                    <li>Peaceful neighborhood near parks</li>
                </ul>
        ...
        <div class="row mt-5">
            <div class="col-12">
                ...
                <div class="map-container">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3154.5258352954283!2d-120.3638761!3d50.6377832!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x537e2bc5ba7b6f23%3A0x744fdb00385d52af!2sAberdeen%20Mall!5e0!3m2!1sen!2sca!4v1698828900000"
                        allowfullscreen=""
                        loading="lazy"></iframe>
                </div>
            </div>
